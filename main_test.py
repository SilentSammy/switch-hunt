...
starting_pos = [
    ...
    [SCREEN_WIDTH * 1.5 / 4, SCREEN_HEIGHT * 0.9 / 4],
    [SCREEN_WIDTH / 4, SCREEN_HEIGHT * 3 / 4],
    [SCREEN_WIDTH * 3 / 4, SCREEN_HEIGHT * 3 / 4]
]
players = [Player(starting_pos[i], colors[i]) for i in range(2)]
...
def update(delta_time):
    ...
    print(players[0].get_rel_speed(players[1]))
